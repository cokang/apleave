...
var PDFPageView = function () {
  ...
  _createClass(PDFPageView, [{
    ...
    value: function reset() {
      ...
      var div = this.div;
      div.style.width = '100%';//Math.floor(this.viewport.width) + 'px';
      div.style.height = 'auto';//Math.floor(this.viewport.height) + 'px';
    ...
    value: function paintOnCanvas(canvasWrapper) {
      ...
      canvas.style.width = '100%';//(0, _ui_utils.roundToDivide)(viewport.width, sfx[1]) + 'px';
      canvas.style.height = '100%';//(0, _ui_utils.roundToDivide)(viewport.height, sfy[1]) + 'px';
