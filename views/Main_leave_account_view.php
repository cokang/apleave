    ...
    <div class="panel panel-primary">
      <div class="panel-body">
        <form method="POST" action="">
          ...
          <span style="display:inline-block; width:120px;"><input type="checkbox" name="excol_chk[]" id='ch3' value="Family_Sick"<?php echo set_checkbox('excol_chk[]', 'Family_Sick'); ?><?= in_array('Family_Sick',$excol) ? 'checked' : '' ?> onchange="return testchk(this.id)"> Family Sick</span>
  ...
  <div class="row"> 
    ...
    <div class="col-lg-12">
      <div class="panel panel-default">
        <div class="panel-heading" style="text-align:left; display:inline-block; width:50%; color:red; font-size:12px; height:42px;"><?=date('m') == 1 ? '*Leave carried are estimates only until to be confirmed on the month February' : '' ?></div>
        <div class="panel-heading" style="text-align:right; display:inline-block; float:right; width:50%; height:42px;"><b> E - Eligible   &nbsp;&nbsp;&nbsp;&nbsp; C - Carry   &nbsp;&nbsp;&nbsp;&nbsp;T - Taken &nbsp;&nbsp;&nbsp;&nbsp;B - Balance</b></div>
        <!-- /.panel-heading -->
        <div class="panel-body">
