 <div class="navbar-default navbar-static-side" role="navigation" >
      <div class="sidebar-collapse">
		...
		<?php $num2 = 1?>
          ...
          <?= ($this->input->get('tab') == $num2++) ? '<li class="active">' : '<li>'?><a href="<?php echo base_url(); ?>index.php/Controllers/leave_account_view?tab=<?=$num++?>" class="ahref"><i class="fa fa-paperclip fa-fw"></i>Leave Accounts</a></li>
          <?php if (($hrrow == 1) OR ($headrow == 1)){ ?>
          ...
          <?php if ($headrow == 1){ ?>
          <?= ($this->input->get('tab') == $num2++) ? '<li class="active">' : '<li>'?><a href="<?php echo base_url(); ?>index.php/Controllers/leave_approved?tab=<?=$num++?>" class="ahref"><i class="fa fa-exchange fa-fw"></i>Leave Approved</a></li>
          <?php } ?>
          ...
          <?= ($this->input->get('tab') == $num2++) ? '<li class="active">' : '<li>'?><a href="<?php echo base_url(); ?>index.php/Controllers/employee_guide?tab=<?=$num++?>" class="ahref"><i class="fa fa-lock fa-fw"></i>Employee Guide</a></li>
        </ul>
        <!-- /#side-menu --> 
      </div>
      <!-- /.sidebar-collapse --> 
