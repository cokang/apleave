<div class="navbar-default navbar-static-side" role="navigation" >
	<div class="sidebar-collapse">
		...
		<?php if ($this->session->userdata('passvalidity') == "valid") {?>
			...
			<?= ($this->input->get('tab') == $num2++) ? '<li class="active">' : '<li>'?><a href="<?php echo base_url(); ?>index.php/Controllers/others?tab=<?=$num++?>" class="ahref"><i class="fa fa-book fa-fw"></i>Guidelines Manual</a></li>
		<?php } else { ?>
			<?= ($this->input->get('tab') == $num2++) ? '<li class="active">' : '<li>'?><a href="<?php echo base_url(); ?>index.php/Controllers/change_password?tab=<?=$num++?>" class="ahref"><i class="fa fa-lock fa-fw"></i>Change Password</a></li>
		<?php } ?>
