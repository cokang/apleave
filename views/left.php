      ...
      <div class="sidebar-collapse">
		...
		<?php $num2 = 1?>
          ...
          <?php if (($hrrow == 1) OR ($headrow == 1)){ ?>
           <?= ($this->input->get('tab') == $num2++) ? '<li class="active">' : '<li>'?><a href="<?php echo base_url(); ?>index.php/Controllers/date_calender?tab=<?=$num++?>" class="ahref"><i class="fa fa-calendar fa-fw"></i>Leave Calendar</a></li>
          <?php } ?> 
          <?php if ($hrrow == 1) { ?> 
