			...
			<div class="col-lg-12">
                ...
                <tbody >
				  ...
				  <tr>
				   ...
				   <tr>
					<td class="td8 tdheight" colspan="2" align="center"><hr class='dotted'/><span><b>Tandatangan Pekerja</b><br/><i>Staff Signature</i> </span></td>
					<td colspan="3"></td>
					<td class="td8" colspan="5" align="center" style="padding-left:20px;"> <span class="text-pr"><?=isset($record[0]->application_date) ? date("d-m-Y",strtotime($record[0]->application_date)) : ''?></span><hr class='dotted'/><span><b>Tarikh</b><br/><i>Date</i> </span></td>
				  </tr>
                </tbody>
              </table>
			  <table class="table-custom" border="0">
                <tbody >
				  ...
				  <tr>
					<td class="td9" colspan="2" align="center"><hr class='dotted'/><span><b>Tandatangan Pekerja</b><br/><i>Staff Signature</i> </span></td>
					<td class="none"></td>
					<td class="td10" colspan="" align="center"><span class="text-pr"><?=isset($record[0]->application_date) ? date("d-m-Y",strtotime($record[0]->application_date)) : ''?></span><hr class='dotted'/><span><b>Tarikh</b><br/><i>Date</i> </span></td>
				  </tr>
                </tbody>
              </table>
			  <table class="table-custom" border="0">
			  ...
			  <table class="table-custom" border="0">
                <tbody >
				  ...
				  <tr>
                    <td colspan="4"><b>Saya memperakukan/tidak memperakukan<span class="spacehr2"> &nbsp;<hr class='dotted'/></span>hari cuti pekerja di atas, kerana kerja-kerja beliau boleh/tidak boleh  dilaksanakan oleh pekerja lain semasa beliau bercuti.(*potong mana tidak tidak berkenaan) </b><br/>
				  ...
				  <tr>
					<td class="td9" colspan="2" align="center"><hr class='dotted'/><span><b>Tandatangan & Cop</b><br/><i>Signature</i> </span></td>
					<td class="none"></td>
					<td class="td10" colspan="" align="center"><?=isset($record[0]->date_approved) ? date("d-m-Y",strtotime($record[0]->date_approved)) : ''?><hr class='dotted'/><span><b>Tarikh</b><br/><i>Date</i> </span></td>
				  </tr>
                </tbody>
              </table>
			  <table class="table-custom" border="0">
